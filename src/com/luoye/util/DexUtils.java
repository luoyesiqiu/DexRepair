...
public class DexUtils {
    ...
    public static void patch(String dexFile, List<CodeItem> codeItems, boolean outputLog) {
        ...
        byte[] dexData = IoUtils.readFile(inDexFile.getAbsolutePath());
        ...
        RandomAccessFile randomOutAccessFile = null;
        int patchCount = 0;
        try {

            randomOutAccessFile = new RandomAccessFile(outFile, "rw");
            fixDexMagic(randomOutAccessFile);
            ...
            IoUtils.close(randomOutAccessFile);
        }
